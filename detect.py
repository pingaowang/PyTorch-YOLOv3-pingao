...
if __name__ == "__main__":
    ...
    parser.add_argument("--class_path", type=str, default="data/yolo_cad_dataset_v2/classes.names", help="path to class label file")
    parser.add_argument("--color_path", type=str, default="data/yolo_cad_dataset_v2/ccolor.txt", help="path to class label file")
